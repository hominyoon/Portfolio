...
E.Options.args.clickset = {
	...
	args = {
		...
		spec1 = {
			...
			set = function(info, value) E.db.clickset.spec1[ info[#info] ] = value; UF:CreateAndUpdateHeaderGroup('raid'); UF:CreateAndUpdateHeaderGroup('party') end,			
			args = {		
				MouseButton1 = {
					order = 4,
					type = "group",
...
--[[ 						MOUSEWHEELUP = {
		...
		spec2 = {
			...
			set = function(info, value) E.db.clickset.spec2[ info[#info] ] = value; UF:CreateAndUpdateHeaderGroup('raid'); UF:CreateAndUpdateHeaderGroup('party')  end,
