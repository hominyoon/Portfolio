	...
	args = {
		...
		consolidatedBuffs = {
			...
			args = {
				...
				consolidateTo = {
					order = 1,
					name = L['consolidateTo'],
					desc = L['Consolidated buffs will be consolidate to consolideBuffs'],
					type = 'toggle',
					get = function() return E.db.auras.consolidatedBuffs.consolidateTo end,
					set = function(info, value) E.db.auras.consolidatedBuffs.consolidateTo = value; A:UpdateHeader(ElvUIPlayerBuffs); end,
				},				
				filter = {
					order = 2,
