		...
		general = {
			...
			args = {
				...
				itemLevelMark = {
					order = 4,
					type = 'range',
					name = L['Display the tag is itemlevel less than value'],
					desc = L['Set to 0 to disable.'],
					min = 0, max = 1000, step = 1,
					set = function(info, value) E.db.bags.itemLevelMark = value; end,
				},
				itemLevelFormat = {
					order = 5,
					type = 'select',
					name = L['tag format'],
					disabled = function() return E.db.bags.itemLevelMark < 1; end,
					values = {
						['asterisk'] = L['asterisk'],
						['number'] = L['number'],
					},
					set = function(info, value) E.db.bags.itemLevelFormat = value; B:UpdateAllSlots(); end,
				},
				sortInverted = {
					order = 99,
					type = 'toggle',
