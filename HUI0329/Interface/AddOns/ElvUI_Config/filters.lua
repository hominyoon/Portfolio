	...
	elseif selectedFilter == 'Raid Damage reduction' then
		...
		if selectedSpell and tableIndex then
			...
			E.Options.args.filters.args.filterGroup.args[name] = {
				name = name..' ('..selectedSpell..')',
				type = 'group',
				get = function(info) return E.global.unitframe.buffwatch['ALL'][tableIndex][ info[#info] ] end,
				set = function(info, value) 
					E.global.unitframe.buffwatch['ALL'][tableIndex][ info[#info] ] = value;
					UF:UpdateAuraWatchFromHeader('raid')
				--	UF:UpdateAuraWatchFromHeader('raid40')
					UF:UpdateAuraWatchFromHeader('party')
					UF:UpdateAuraWatchFromHeader('raidpet', true)
				...
				args = {
					...
					color = {
						...
						order = 5,
						get = function(info)
							local t = E.global.unitframe.buffwatch['ALL'][tableIndex][ info[#info] ]
							return t.r, t.g, t.b, t.a
						end,
						set = function(info, r, g, b)
							local t = E.global.unitframe.buffwatch['ALL'][tableIndex][ info[#info] ]
					...
					textColor = {
						...
						set = function(info, r, g, b)
							E.global.unitframe.buffwatch['ALL'][tableIndex][ info[#info] ] = E.global.unitframe.buffwatch['ALL'][tableIndex][ info[#info] ] or {}
							local t = E.global.unitframe.buffwatch['ALL'][tableIndex][ info[#info] ]
							t.r, t.g, t.b = r, g, b
							UF:UpdateAuraWatchFromHeader('raid')
						--	UF:UpdateAuraWatchFromHeader('raid40')
					...
					onlyShowMissing = {
						...
						order = 11,
						type = 'toggle',	
						disabled = function() return E.global.unitframe.buffwatch['ALL'][tableIndex].style == 'text' end,
					},
					size = {
						name = L['Size'],
						order = 12,
	...
	elseif selectedFilter == 'Char Damage reduction' then
		...
		if selectedSpell and tableIndex then
			...
			E.Options.args.filters.args.filterGroup.args[name] = {
				name = name..' ('..selectedSpell..')',
				type = 'group',
				get = function(info) return E.global.unitframe.buffwatch['CHAR'][tableIndex][ info[#info] ] end,
				set = function(info, value) 
					E.global.unitframe.buffwatch['CHAR'][tableIndex][ info[#info] ] = value;
					UF:UpdateAuraWatchFromHeader('raid')
				--	UF:UpdateAuraWatchFromHeader('raid40')
					UF:UpdateAuraWatchFromHeader('party')
					UF:UpdateAuraWatchFromHeader('raidpet', true)
				...
				args = {
					...
					color = {
						...
						order = 5,
						get = function(info)
							local t = E.global.unitframe.buffwatch['CHAR'][tableIndex][ info[#info] ]
							return t.r, t.g, t.b, t.a
						end,
						set = function(info, r, g, b)
							local t = E.global.unitframe.buffwatch['CHAR'][tableIndex][ info[#info] ]
					...
					textColor = {
						...
						set = function(info, r, g, b)
							E.global.unitframe.buffwatch['CHAR'][tableIndex][ info[#info] ] = E.global.unitframe.buffwatch['CHAR'][tableIndex][ info[#info] ] or {}
							local t = E.global.unitframe.buffwatch['CHAR'][tableIndex][ info[#info] ]
							t.r, t.g, t.b = r, g, b
							UF:UpdateAuraWatchFromHeader('raid')
						--	UF:UpdateAuraWatchFromHeader('raid40')
					...
					onlyShowMissing = {
						...
						order = 11,
						type = 'toggle',	
						disabled = function() return E.global.unitframe.buffwatch['CHAR'][tableIndex].style == 'text' end,
					},
					size = {
						name = L['Size'],
						order = 12,
