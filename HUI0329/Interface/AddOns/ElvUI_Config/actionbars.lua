...
E.Options.args.actionbar = {
	...
	args = {
		...
		rightClickCast = {
			order = 2,
			type = "toggle",
			name = L["Right Click to self-cast"],
			get = function(info) return E.private.actionbar[ info[#info] ] end,
			set = function(info, value) E.private.actionbar[ info[#info] ] = value; E:StaticPopup_Show("PRIVATE_RL") end
		},
		toggleKeybind = {
		...
		extraButtonScale = {
			...
			name = L['ExtraButton Scale'],
			get = function(info) return E.db.actionbar.extraButtonScale; end,
			set = function(info, value) E.db.actionbar.extraButtonScale = value; E:StaticPopup_Show("PRIVATE_RL"); end,
		},
		extraButtonClear = {
			type = 'toggle',
			order = 12,
			name = L['Clear Extra Button'],
			get = function(info) return E.db.actionbar.extraButtonClear; end,
			set = function(info, value) E.db.actionbar.extraButtonClear = value; E:StaticPopup_Show("PRIVATE_RL"); end,
		},
		euiabstyle = {
			order = 14,
			type = 'select',
