	...
	local config = {
		...
		args = {
			...
			forceshow = {
				order = 3,
				name = SHOW..' / '..HIDE,
				disabled = function() return groupName == 'party' end,
				func = function() 
...
E.Options.args.unitframe.args.party = {
	...
	args = {
		...
		castbar = GetOptionsTable_Castbar(false, UF.CreateAndUpdateHeaderGroup, 'party', 5), --by eui.cc
		petsGroup = {
			order = 800,
			type = 'group',
			name = L['Party Pets'],
	...
	args = {
		...
		buffIndicator = {
			...
			args = {
				...
				configureButton = {
					type = 'execute', 
					name = L['Configure Buff Indicator'],
					width = 'full',
					func = function() E:SetToFilterConfig('Buff Indicator') end,
					order = 5
				},
	...
	elseif E.myclass == 'SHAMAN' then
		...
		for i = 1, 5 do
			E.Options.args.unitframe.args.general.args.allColorsGroup.args.classResourceGroup.args['resource'..i] = {
				...
				order = ORDER + i,
				get = function(info)
					local t = E.db.unitframe.colors.classResources.SHAMAN[i]
					local d = P.unitframe.colors.classResources.SHAMAN[i]
					return t.r, t.g, t.b, t.a, d.r, d.g, d.b
				end,
				set = function(info, r, g, b)
					E.db.unitframe.colors.classResources.SHAMAN[i] = {}
					local t = E.db.unitframe.colors.classResources.SHAMAN[i]
					t.r, t.g, t.b = r, g, b
					UF:Update_AllFrames()
				end,			
