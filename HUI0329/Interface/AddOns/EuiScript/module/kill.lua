...
function K:Toggle()
	if self.db.enable and (UnitLevel('player') > 80) then
...
function K:Initialize()
	...
	E:CreateMover(f, "EuiExecuteMover", GetSpellInfo(5308), nil, nil, nil, "ALL,EUI", function() return E.db.euiscript.executebutton.enable; end)
