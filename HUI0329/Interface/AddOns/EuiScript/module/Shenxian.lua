...
local SPELLNAME1, _, TEXTURE1 = GetSpellInfo(30451)
local SPELLNAME2, _, TEXTURE2 = GetSpellInfo(5143)
local SPELLNAME3, _, TEXTURE3 = GetSpellInfo(44425)

local ShenxianFrame = CreateFrame("Frame", "EUIShenxianFrame", UIParent)
ShenxianFrame:SetSize(E.db.euiscript.shenxian.size, E.db.euiscript.shenxian.size)
ShenxianFrame:SetPoint("CENTER", UIParent, "CENTER", 0, 150)
