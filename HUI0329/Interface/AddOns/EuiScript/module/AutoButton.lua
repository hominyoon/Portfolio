...
----------------------------------------------------------------------------------------
--	AutoButton (by eui.2015/02/07)
----------------------------------------------------------------------------------------
local QuestItemList = {}
local _, MCAP = C_Garrison.GetBuildingInfo(61);
local _, SCAP = C_Garrison.GetBuildingInfo(52);

local garrisonsmv = {118897, 118903}
local garrisonsc = {114116, 114119, 114120}
...
function S:ScanItem(event)
	...
	elseif minimapZoneText == SCAP then
