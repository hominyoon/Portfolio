...
elseif (GetLocale() == "koKR") then
	L.RaidCheckMsgOUTRAID = "당신은 공격대에 속해있지 않습니다"
	L.RaidCheckMsgFullBuff = "공대원 버프체크：전원 버프 있음！"
	L.RaidCheckMsgNoBuff = "공대원 버프체크：부족한 버프 확인！"
		
	L.RaidCheckMsgPosition = "자리비움 확인"
	L.RaidCheckMsgAllInPlace = "%s 전체 자리비움 확인"
	L.RaidCheckMsgInPlace = "%s 공대원이 자리에 있습니다"
	L.RaidCheckMsgDead = "%s 공대원이 사망했습니다"
	L.RaidCheckMsgOffline = "%s 공대원이 오프라인입니다"
	L.RaidCheckMsgUnVisible = "%s 공대원이 너무 멀리 있습니다"
	L.RaidCheckMsgETC = "등등."

	L.RaidCheckFlaskData = {
			"영약",
		}
	L.RaidCheckMsgFlask = "영약 검사"
	L.RaidCheckMsgAllNoFlask = "전원 영약 효과 없음"
	L.RaidCheckMsgAllHasFlask = "전원 영약 효과 있음"
	L.RaidCheckMsgNoFlask = "%s 어떤 영약 효과 없음"
	L.RaidCheckMsgHasFlask = "%s 기존 영약 효과"

	L.RaidCheckTipLeftButtonOnLeftInfo = "공대원 거리체크"
	L.RaidCheckTipRightButtonOnLeftInfo = "공대원 전투준비"
	L.RaidCheckTipLeftButtonOnRightInfo = "공대원 버프체크"
	L.RaidCheckTipRightButtonOnRightInfo = "공대원 영약체크"
	L.RAIDCHECK_RAIDTOOL = "공격대 패널 열기"

	L.MouseLeftButton = "마우스 왼쪽 버튼"
	L.MouseRightButton = "오른쪽 마우스 버튼"
	L.MouseClick = "마우스 클릭"
	L.BottomPanelRaidCheck = "레이드 체크"
	L.GameSetting = "열기 인터페이스를 설정합니다"
...
--[[
L.RaidCheckBuff1 = {GN(1126),GN(117666),GN(20217)} 
L.RaidCheckBuff2 = {GN(21562),GN(109773),GN(469)} 
L.RaidCheckBuff3 = {GN(19506),GN(6673),GN(57330)} 
L.RaidCheckBuff4 = {GN(113742),GN(30809),GN(55610)} 
L.RaidCheckBuff5 = {GN(1459),GN(61316),GN(77747),GN(109773)} 
L.RaidCheckBuff6 = {GN(49868),GN(24907),GN(51470)} 
L.RaidCheckBuff7 = {GN(1459),GN(61316),GN(24932),GN(116781)} 
L.RaidCheckBuff8 = {GN(116956),GN(19740)} 
L.RaidCheckBuff9 = GN(87564) 
]]
--wod 6.0 by EUI
L.RaidCheckBuff1 = {GN(1126),GN(115921),GN(116781),GN(20217)} 
L.RaidCheckBuff2 = {GN(21562),GN(166928),GN(469)} 
L.RaidCheckBuff3 = {GN(19506),GN(6673),GN(57330)} 
L.RaidCheckBuff4 = {GN(49868),GN(113742),GN(116956),GN(55610)} 
L.RaidCheckBuff5 = {GN(1459),GN(61316),GN(109773)} 
L.RaidCheckBuff6 = {GN(1459),GN(61316),GN(24932),GN(116781)} 
L.RaidCheckBuff7 = {GN(116956),GN(19740),GN(24907),GN(155522)} 
L.RaidCheckBuff8 = {GN(166916),GN(49868),GN(113742),GN(109773)} 
L.RaidCheckBuff9 = {GN(55610),GN(1126),GN(167187),GN(167188)} 
L.RaidCheckBuff10 = GN(87564) 
-------------------------------------------------------------------------------------------------------------------
--	Buff검사
-------------------------------------------------------------------------------------------------------------------
