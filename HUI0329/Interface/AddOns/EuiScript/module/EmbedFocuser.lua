...
local modifier = E.db.euiscript.embedfocuser1 or "shift" -- "shift" , "alt" , "ctrl"  --키 변경
local mouseButton = E.db.euiscript.embedfocuser2 or "1" -- "1" = 좌측, "2" = 우측, "3" = 중간, "4" and "5" --마우스 변경
