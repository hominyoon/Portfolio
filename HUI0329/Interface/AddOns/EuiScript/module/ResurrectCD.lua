...
function RD:CreateAnchor()
	...
	f:SetSize(E.db.euiscript.rescd.width, E.db.euiscript.rescd.height)
	f:SetTemplate("Transparent")
	f:SetPoint("TOP", 120, -80)
	f:Hide()
	...
	f.num:SetPoint("CENTER", f.Icon, "CENTER", 0, 0)
	
	f.timer = f:CreateFontString(nil, "OVERLAY")
	f.timer:SetPoint("LEFT", f, "LEFT", 2, 0)
