...
local function OnEvent(self, event, ...)
	...
	ElvDB['worldBoss'][E.myfullname].rukhmarKilled = IsQuestFlaggedCompleted(37464)
	ElvDB['worldBoss'][E.myfullname].tarlnaKilled = IsQuestFlaggedCompleted(37462)
	ElvDB['worldBoss'][E.myfullname].drovKilled = IsQuestFlaggedCompleted(37460)	
end
