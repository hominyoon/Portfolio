...
elseif GetLocale() == 'koKR' then
	LL.RaidCheckTipLeftButtonOnLeftInfo = "장소 상황"
	LL.RaidCheckTipRightButtonOnLeftInfo = "장소 인식"
	LL.RaidCheckTipLeftButtonOnRightInfo = "검사BUFF"
	LL.RaidCheckTipRightButtonOnRightInfo = "영약확인"
else
...
DT:RegisterDatatext('E_Raidtool', {'PLAYER_ENTER_WORLD'}, OnEvent, nil, Click, nil, nil)