...
AB["barDefaults"] = {
	...
	--	['conditions'] = format("[vehicleui] %d; [possessbar] %d; [overridebar] %d; [form,noform] 0; [bar:2] 2; [bar:3] 3; [bar:4] 4; [bar:5] 5; [bar:6] 6;", GetVehicleBarIndex(), GetVehicleBarIndex(), GetOverrideBarIndex()),
		--Fixed action bar for Tharon'ja.
	--	['conditions'] = format("[vehicleui, mod:alt, mod:ctrl] %d; [vehicleui][possessbar] %d; [shapeshift] %d;[overridebar] %d; [form,noform] 0; [bar:2] 2; [bar:3] 3; [bar:4] 4; [bar:5] 5; [bar:6] 6;", GetVehicleBarIndex()+1, GetVehicleBarIndex(), GetVehicleBarIndex()+1, GetOverrideBarIndex()),
		['conditions'] = format("[vehicleui] %d; [possessbar] %d; [shapeshift] %d;[overridebar] %d; [form,noform] 0; [bar:2] 2; [bar:3] 3; [bar:4] 4; [bar:5] 5; [bar:6] 6;", GetVehicleBarIndex(), GetVehicleBarIndex(), GetVehicleBarIndex()+1, GetOverrideBarIndex()),
...
function AB:EuiStyle(value)
	...
	E.db.movers.ElvAB_1 = string.format('%s\031%s\031%s\031%d\031%d','BOTTOM', 'ElvUIParent', 'BOTTOM', 0, 4 + offsetX1)
	if value == 'Low' then	
		E.db.movers.ElvAB_2 = string.format('%s\031%s\031%s\031%d\031%d','BOTTOM', 'ElvUIParent', 'BOTTOM', 0, 4 + self.db['bar1'].buttonsize + self.db['bar1'].buttonspacing + offsetX1)
		E.db.movers.ElvAB_3 = string.format('%s\031%s\031%s\031%d\031%d', 'BOTTOM', 'ElvUIParent', 'BOTTOM', 0, 4 + self.db['bar1'].buttonsize + self.db['bar1'].buttonspacing + self.db['bar2'].buttonsize + self.db['bar2'].buttonspacing + offsetX1)
		E.db.movers.ElvAB_4 = string.format('%s\031%s\031%s\031%d\031%d', 'RIGHT', 'ElvUIParent', 'RIGHT', -4, 0)
		E.db.movers.ElvAB_5 = string.format('%s\031%s\031%s\031%d\031%d', 'RIGHT', 'ElvUIParent', 'RIGHT', -(4 + self.db['bar4'].buttonsize + self.db['bar4'].buttonspacing), 0)
		E.db.movers.PetAB = string.format('%s\031%s\031%s\031%d\031%d', 'RIGHT', 'ElvUIParent', 'RIGHT', -(4 + self.db['bar4'].buttonsize + self.db['bar4'].buttonspacing) - self.db['bar5'].buttonsize - self.db['bar5'].buttonspacing * 2 - 4, 0)
	elseif value == 'Middle' then
		E.db.movers.ElvAB_2 = string.format('%s\031%s\031%s\031%d\031%d', 'BOTTOM', 'ElvUIParent', 'BOTTOM', 0, 4 + self.db['bar1'].buttonsize + self.db['bar1'].buttonspacing + offsetX1)
		E.db.movers.ElvAB_4 = string.format('%s\031%s\031%s\031%d\031%d', 'BOTTOM', 'ElvUIParent', 'BOTTOM', 0, 4 + self.db['bar1'].buttonsize + self.db['bar1'].buttonspacing + self.db['bar2'].buttonsize + self.db['bar2'].buttonspacing + offsetX1)
		E.db.movers.ElvAB_3 = string.format('%s\031%s\031%s\031%d\031%d', 'BOTTOMLEFT', 'ElvUIParent', 'BOTTOM', 4 + self.db['bar4'].buttonsize * 6 + self.db['bar4'].buttonspacing * 7, 4 + offsetX3)
		E.db.movers.ElvAB_5 = string.format('%s\031%s\031%s\031%d\031%d', 'BOTTOMRIGHT', 'ElvUIParent', 'BOTTOM', -(4 + self.db['bar4'].buttonsize * 6 + self.db['bar4'].buttonspacing * 7), 4 + offsetX5)
		E.db.movers.PetAB = string.format('%s\031%s\031%s\031%d\031%d', 'RIGHT', 'ElvUIParent', 'RIGHT', -4, 0)
	elseif value == 'High' then
		E.db.movers.ElvAB_2 = string.format('%s\031%s\031%s\031%d\031%d', 'BOTTOM', 'ElvUIParent', 'BOTTOM', 0, 4 + self.db['bar1'].buttonsize + self.db['bar1'].buttonspacing + offsetX1)
		E.db.movers.ElvAB_4 = string.format('%s\031%s\031%s\031%d\031%d', 'RIGHT', 'ElvUIParent', 'RIGHT', -4, 0)
		E.db.movers.ElvAB_3 = string.format('%s\031%s\031%s\031%d\031%d', 'BOTTOMLEFT', 'ElvUIParent', 'BOTTOM', 4 + self.db['bar4'].buttonsize * 6 + self.db['bar4'].buttonspacing * 7, 4 + offsetX3)
		E.db.movers.ElvAB_5 = string.format('%s\031%s\031%s\031%d\031%d', 'BOTTOMRIGHT', 'ElvUIParent', 'BOTTOM', -(4 + self.db['bar4'].buttonsize * 6 + self.db['bar4'].buttonspacing * 7), 4 + offsetX5)
		E.db.movers.PetAB = string.format('%s\031%s\031%s\031%d\031%d', 'RIGHT', 'ElvUIParent', 'RIGHT', -(4 + self.db['bar4'].buttonsize + self.db['bar4'].buttonspacing * 2 + 4), 0)
	end
end
