...
function A:UpdateHeader(header)
	...
	if header:GetAttribute('filter') == 'HELPFUL' then
		db = self.db.buffs
		header:SetAttribute("consolidateTo", self.db.consolidatedBuffs.consolidateTo == true and E.private.general.minimap.enable == true and 1 or 0)
...
function A:Initialize()
	...
	E:CreateMover(self.BuffFrame, "BuffsMover", L["Player Buffs"], nil, nil, nil, nil, function() return E.private.auras.enable; end)
