...
function UF:Construct_TargetTargetTargetFrame(frame)	
	frame.Health = self:Construct_HealthBar(frame, true, true, 'RIGHT', E.db.unitframe.units.targettargettarget.health.orientation)
	
	frame.Power = self:Construct_PowerBar(frame, true, true, 'LEFT', E.db.unitframe.units.targettargettarget.power.orientation)
	...
	E:CreateMover(frame, frame:GetName()..'Mover', L['TargetTargetTarget Frame'], nil, nil, nil, 'ALL,SOLO', function() return E.db.unitframe.units.targettargettarget.enable; end)
end
