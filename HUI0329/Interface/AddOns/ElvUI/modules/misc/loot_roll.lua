...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	f:Point(...)
	f:Size(E.db.general.lootHeight - 4)
...
function M:CreateRollFrame()
	...
	frame:Size(E.db.general.lootWidth, E.db.general.lootHeight)
	...
	button:Size(E.db.general.lootHeight - (E.Border * 2))
	...
	spark:Size(14, E.db.general.lootHeight)
