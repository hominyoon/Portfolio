...
local function ClassBuff(id, point, color, anyUnit, onlyShowMissing, style, displayText, textColor, textThreshold, xOffset, yOffset, size, haveAnimation)
...
G.unitframe.buffwatch = {
	...
	ALL = {
	--	ClassBuff(740, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --宁静
		ClassBuff(97463, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true),--集结呐喊*
		ClassBuff(64844, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --神圣赞美诗*
		ClassBuff(81782, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --真言术：障*
		ClassBuff(15286, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --吸血鬼的拥抱
		ClassBuff(31821, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --虔诚光环
		ClassBuff(88611, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --烟雾弹*
		ClassBuff(145629, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --反魔法领域
	--	ClassBuff(108280, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --治疗之潮图腾
		ClassBuff(98007, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --灵魂链接图腾*
		ClassBuff(172106, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --灵狐守护*
		ClassBuff(159916, "TOP", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --魔法增效
	},
	CHAR = { --个人减伤组
		ClassBuff(48707, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --反魔法护罩
		ClassBuff(30823, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --萨满之怒
		ClassBuff(33206, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --痛苦压制
		ClassBuff(47585, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --消散
		ClassBuff(871, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --盾墙
		ClassBuff(48792, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --冰封之韧
		ClassBuff(498, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --圣佑术
		ClassBuff(22812, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --树皮术
		ClassBuff(61336, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --生存本能
		ClassBuff(5277, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --闪避
		ClassBuff(74001, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --备战就绪
		ClassBuff(47788, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --守护之魂
		ClassBuff(19263, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --威慑
		ClassBuff(6940, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --牺牲之手
		ClassBuff(31850, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --炽热防御者
		ClassBuff(31224, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --暗影斗篷
		ClassBuff(42650, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --亡者大军
		ClassBuff(86657, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --远古守卫
		ClassBuff(118038, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --剑在人在
		ClassBuff(115176, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --禅悟冥想
		ClassBuff(115308, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --飘渺酒
		ClassBuff(120954, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --壮胆酒
		ClassBuff(115295, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --金钟罩
		ClassBuff(51271, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --冰霜之柱
		ClassBuff(12975, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --破釜沉舟
		ClassBuff(97463, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --集结呐喊
		ClassBuff(102342, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --铁木树皮
		ClassBuff(114039, "BOTTOM", {1, 0, 0}, true, nil, "texturedIcon", nil, nil, nil, nil, nil, 14, true), --纯净之手
	},
}
