...
E.PopupDialogs['ELVUI_UPDATE_AVAILABLE'] = {
	text = L["Your version of ElvUI is out of date. You can download the latest version from http://www.tukui.org"],
	hasEditBox = 1,
	...
	EditBoxOnTextChanged = function(self)
		if(self:GetText() ~= "http://www.eui.cc") then
			self:SetText("http://www.eui.cc")
		end
		self:HighlightText()
		self:ClearFocus()
		ChatEdit_FocusActiveWindow();
