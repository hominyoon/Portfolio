...
if ((GetLocale() == 'koKR') or (GetLocale() == 'koKR')) then E.kolocale = true; else E.kolocale = false; end;
E.LSM = LSM
...
function E:Print(msg)
	print(self["media"].hexvaluecolor..'EUI:|r', msg)
end
...
function E:CheckRole()
	...
	if role == "Tank" and (IsInPvPGear or IsSpellKnown(156291)) then
		role = "Melee"
	end
...
function E:UpdateAll(ignoreInstall)
	...
	if self.private.install_complete == nil or (self.db.install_complete and type(self.db.install_complete) == 'boolean') or (self.db.install_complete and type(tonumber(self.db.install_complete)) == 'number' and tonumber(self.db.install_complete) <= 3.83) then
